    ...
    <div class="form-group">
      <div class="row">
        <div class="col-8">
          ...
          <input value="{{old('image', asset('storage/'.$apartment->image))}}" type="file" class="form-control" name="image" id="image-field" placeholder="https://example.com/" size="30" required>
        </div>
        <div class="col-4">
